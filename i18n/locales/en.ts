...
const en = {
  ...
  settings: {
    ...
    subagentTitle: "SUB-AGENT MODEL",
    subagentAuto: "Auto",
    subagentAutoSub: "Use the orchestration model, or the main one if none is set.",
    subagentFooter:
      "When the agent delegates a focused task with spawn_subagent, this model runs the sub-loop. Cheaper is usually better — sub-agents start with fresh context and read-only tools.",
    subagentMaxSteps: "SUB-AGENT MAX ROUNDS",
    ...
    mcpSub: "Connect any tool from the MCP ecosystem.",
    customToolsTitle: "Custom HTTP tools",
    customToolsSub: "Wire the agent to any REST API you have.",
    extensionsFooter:
      "MCP brings hosted servers (Linear, Sentry, Notion, Zapier's 5000+ apps). Custom HTTP tools cover anything else — your own backend, an internal API, a niche SaaS.",
  },
  ...
  mcp: {
    ...
    listIntro:
      "MCP (Model Context Protocol) is the open standard for AI-tool connections. Connect any MCP server here and every tool it exposes becomes available to the agent.",
    listFooter:
      "Servers are handshaked on connect and cached locally. If a server goes down, its tools disappear from the agent's toolkit — no silent failures.",
    emptyTitle: "No servers connected yet",
    emptyBody:
      "Connect Linear, Sentry, Notion, or any other MCP server. Zapier alone unlocks 5000+ apps.",
    addFirst: "Add a server",
    addTitle: "Add MCP server",
    addSubtitle: "Pick a popular one or enter a custom URL.",
    popular: "POPULAR",
    addCustom: "Custom MCP server",
    addFooter:
      "The URL should point to the MCP endpoint of the server, not the app's landing page.",
    customFormTitle: "Custom server",
    serverDetails: "SERVER",
    serverName: "Name",
    serverUrl: "URL",
    auth: "AUTHENTICATION",
    bearerOptional: "Bearer token (optional)",
    testAndConnect: "Test and connect",
    testFooter: "We'll open a handshake with the server and list its tools before saving.",
    connectedTitle: "Connected",
    connectedToolOne: "Discovered 1 tool.",
    connectedToolOther: "Discovered {{count}} tools.",
    errNameOrUrl: "Give the server a name and its endpoint URL.",
    errInvalidUrl: "That doesn't look like a valid URL.",
    errConnectTitle: "Couldn't connect",
    errRefreshTitle: "Couldn't refresh",
    notFoundTitle: "Server not found",
    notFoundBody: "This server may have been removed.",
    serverInfo: "SERVER",
    url: "URL",
    lastSync: "Last sync",
    never: "Never",
    paused: "Paused",
    pausedHint: "When paused, this server's tools are hidden from the agent.",
    refresh: "Refresh tools",
    toolOne: "{{count}} TOOL",
    toolOther: "{{count}} TOOLS",
    noToolsCached: "No tools cached yet. Tap refresh above.",
    noToolsYet: "No tools yet",
    readOnly: "READ-ONLY",
    trusted: "TRUSTED",
    trustedHint:
      "Trusted tools run without a confirmation prompt. Read-only tools always run without prompting.",
    disconnectTitle: "Disconnect server",
    disconnectBody: "Remove {{name}} and all its tools from the agent's toolkit?",
  },

  customTools: {
    listTitle: "Custom HTTP tools",
    listIntro:
      "Wire the agent to any REST API. If your service doesn't have an MCP server yet, you can still connect it here — declare the endpoint, headers, and parameters, and the agent can call it.",
    listFooter: "Tools you disable stay saved but stop being offered to the agent.",
    emptyTitle: "No custom tools yet",
    emptyBody:
      "Describe an API in plain English and let the agent draft the tool, or start blank.",
    addFirst: "Add a tool",
    paused: "paused",
    newTitle: "New custom tool",
    newSubtitle: "Describe the API, or start from scratch.",
    aiGenerate: "GENERATE FROM DESCRIPTION",
    aiPlaceholder:
      "e.g. Connect to https://api.myapp.com/orders with bearer token XYZ. GET /orders returns a list. POST /orders takes {status, total}.",
    aiHint: "The agent will read the description and draft the tool. You review before saving.",
    generateBtn: "Generate tool",
    orDivider: "or",
    startBlank: "Start blank",
    errNeedDescription: "Type a description first.",
    errGenerate: "Couldn't generate tool",
    errNameOrUrl: "The tool needs a name and a URL.",
    notFoundTitle: "Tool not found",
    meta: "METADATA",
    name: "Name (used internally)",
    label: "Label (shown in the trace)",
    description: "Description (read by the model)",
    descHint:
      "The description is how the model decides when to call this. Be specific: what it does, when to use it, and what returns.",
    request: "REQUEST",
    url: "URL template",
    body: "Body template",
    placeholdersHint: "Use {{param}} to inject a parameter into the URL, headers, or body.",
    headers: "HEADERS",
    noHeaders: "No headers yet.",
    addHeader: "Add header",
    parameters: "PARAMETERS",
    paramsHint:
      "Parameters the model will pass. Their names must match the {{placeholders}} you use above.",
    noParams: "No parameters yet.",
    paramDescPh: "Description for the model",
    required: "Required",
    addParam: "Add parameter",
    behavior: "BEHAVIOR",
    mutates: "Needs approval",
    mutatesHint:
      "Turn on if this tool changes something. The user will be asked to confirm every call.",
    pauseTitle: "Paused",
    pauseHint: "The tool stays saved but the agent won't see it.",
    deleteTitle: "Delete tool",
    deleteBody: "Delete {{name}} for good? This cannot be undone.",
  },
