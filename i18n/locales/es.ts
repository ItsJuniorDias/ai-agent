...
const es: Dict = {
  ...
  settings: {
    ...
    mcpSub: "Conecta cualquier herramienta del ecosistema MCP.",
    customToolsTitle: "Herramientas HTTP personalizadas",
    customToolsSub: "Conecta el agente a cualquier API REST.",
    extensionsFooter:
      "MCP trae servidores listos (Linear, Sentry, Notion, los 5000+ apps de Zapier). HTTP personalizado cubre el resto — tu backend, una API interna, un SaaS de nicho.",
  },
  ...
  mcp: {
    ...
    listIntro:
      "MCP (Model Context Protocol) es el estándar abierto para conectar IA con herramientas. Conecta cualquier servidor MCP aquí y todas sus herramientas estarán disponibles para el agente.",
    listFooter:
      "Los servidores se autentican al conectar y se cachean localmente. Si un servidor cae, sus herramientas desaparecen del kit del agente — sin fallos silenciosos.",
    emptyTitle: "No hay servidores conectados",
    emptyBody:
      "Conecta Linear, Sentry, Notion o cualquier otro servidor MCP. Solo Zapier desbloquea 5000+ apps.",
    addFirst: "Añadir servidor",
    addTitle: "Añadir servidor MCP",
    addSubtitle: "Elige uno popular o introduce una URL personalizada.",
    popular: "POPULARES",
    addCustom: "Servidor MCP personalizado",
    addFooter: "La URL debe apuntar al endpoint MCP del servidor, no a su landing page.",
    customFormTitle: "Servidor personalizado",
    ...
    testFooter: "Haremos un handshake y listaremos las herramientas antes de guardar.",
    connectedTitle: "Conectado",
    connectedToolOne: "Descubierta 1 herramienta.",
    connectedToolOther: "Descubiertas {{count}} herramientas.",
    errNameOrUrl: "Dale un nombre al servidor y su URL.",
    errInvalidUrl: "Eso no parece una URL válida.",
    errConnectTitle: "No se pudo conectar",
    errRefreshTitle: "No se pudo actualizar",
    notFoundTitle: "Servidor no encontrado",
    notFoundBody: "Este servidor puede haber sido eliminado.",
    serverInfo: "SERVIDOR",
    url: "URL",
    lastSync: "Última sincronización",
    never: "Nunca",
    paused: "En pausa",
    pausedHint: "En pausa, las herramientas de este servidor se ocultan del agente.",
    refresh: "Actualizar herramientas",
    toolOne: "{{count}} HERRAMIENTA",
    toolOther: "{{count}} HERRAMIENTAS",
    noToolsCached: "Sin herramientas en caché. Pulsa actualizar arriba.",
    noToolsYet: "Sin herramientas todavía",
    readOnly: "SOLO LECTURA",
    trusted: "CONFIABLE",
    trustedHint:
      "Las herramientas confiables se ejecutan sin confirmar. Las de solo lectura siempre corren sin preguntar.",
    disconnectTitle: "Desconectar servidor",
    disconnectBody: "¿Quitar {{name}} y todas sus herramientas del kit del agente?",
  },

  customTools: {
    listTitle: "Herramientas HTTP",
    listIntro:
      "Conecta el agente a cualquier API REST. Si tu servicio no tiene servidor MCP, aún puedes conectarlo aquí — declara el endpoint, headers y parámetros.",
    listFooter: "Las herramientas desactivadas se guardan pero dejan de ofrecerse al agente.",
    emptyTitle: "Sin herramientas personalizadas",
    emptyBody: "Describe una API en texto y el agente la crea, o empieza en blanco.",
    addFirst: "Añadir herramienta",
    paused: "en pausa",
    newTitle: "Nueva herramienta",
    newSubtitle: "Describe la API o empieza desde cero.",
    aiGenerate: "GENERAR DESDE DESCRIPCIÓN",
    aiPlaceholder:
      "ej: Conecta a https://api.miapp.com/orders con bearer XYZ. GET /orders devuelve una lista. POST /orders recibe {status, total}.",
    aiHint: "El agente lee la descripción y crea la herramienta. Tú revisas antes de guardar.",
    generateBtn: "Generar herramienta",
    orDivider: "o",
    startBlank: "Empezar en blanco",
    errNeedDescription: "Escribe una descripción primero.",
    errGenerate: "No se pudo generar",
    errNameOrUrl: "La herramienta necesita nombre y URL.",
    notFoundTitle: "Herramienta no encontrada",
    meta: "METADATOS",
    name: "Nombre (uso interno)",
    label: "Etiqueta (aparece en el trace)",
    description: "Descripción (el modelo la lee)",
    descHint: "La descripción define cuándo el modelo llama la herramienta. Sé específico.",
    request: "REQUEST",
    url: "Plantilla de URL",
    body: "Plantilla del body",
    placeholdersHint: "Usa {{param}} para inyectar un parámetro en URL, headers o body.",
    headers: "HEADERS",
    noHeaders: "Sin headers todavía.",
    addHeader: "Añadir header",
    parameters: "PARÁMETROS",
    paramsHint:
      "Parámetros que el modelo pasará. Sus nombres deben coincidir con los {{placeholders}} usados arriba.",
    noParams: "Sin parámetros todavía.",
    paramDescPh: "Descripción para el modelo",
    required: "Requerido",
    addParam: "Añadir parámetro",
    behavior: "COMPORTAMIENTO",
    mutates: "Requiere aprobación",
    mutatesHint:
      "Activa si esta herramienta modifica algo. Se pedirá confirmación en cada llamada.",
    pauseTitle: "En pausa",
    pauseHint: "La herramienta queda guardada pero el agente no la ve.",
    deleteTitle: "Eliminar herramienta",
    deleteBody: "¿Eliminar {{name}} definitivamente? No se puede deshacer.",
  },
