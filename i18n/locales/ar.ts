...
const ar: Dict = {
  ...
  settings: {
    ...
    subagentTitle: "نموذج الوكيل الفرعي",
    subagentAuto: "تلقائي",
    subagentAutoSub:
      "يستخدم نموذج التنسيق، أو النموذج الرئيسي إذا لم يُحدَّد.",
    subagentFooter:
      "عندما يفوّض الوكيل مهمة مركّزة عبر spawn_subagent، يقوم هذا النموذج بتشغيل الحلقة الفرعية. النماذج الأرخص عادةً كافية — يبدأ الوكلاء الفرعيون بسياق نظيف وأدوات للقراءة فقط.",
    subagentMaxSteps: "الحد الأقصى لجولات الوكيل الفرعي",
