...
const ar: Dict = {
  ...
  settings: {
    ...
    subagentTitle: "الوكلاء الفرعيون",
    subagentRowTitle: "إعدادات الوكيل الفرعي",
    subagentRowSteps: "الحد الأقصى {{count}} جولة",
    subagentAuto: "تلقائي",
    subagentFooter:
      "اضبط الحلقة الفرعية التي يشغّلها الوكيل الرئيسي عبر spawn_subagent — النموذج والحد الأقصى للجولات.",
    memory: "الذاكرة",
    ...
    mcpTitle: "خوادم MCP",
    mcpSub: "اتصل بأي أداة من منظومة MCP.",
    customToolsTitle: "أدوات HTTP مخصصة",
    customToolsSub: "اربط الوكيل بأي واجهة REST API لديك.",
    extensionsFooter:
      "يوفر MCP خوادم جاهزة (Linear و Sentry و Notion و 5000+ تطبيق من Zapier). تغطي أدوات HTTP المخصصة كل شيء آخر — خادمك الخلفي أو واجهة API داخلية أو SaaS متخصص.",
  },
  ...
  trace: {
    ...
    concluded: "تم",
    failed: "فشل",
    subagentLabel: "وكيل فرعي",
    subStepOne: "{{count}} خطوة داخلية",
    subStepOther: "{{count}} خطوات داخلية",
    subFinished: "اكتمل",
    subMaxSteps: "بلغ الحد",
    subFailed: "فشل",
    tokens: "رمز",
  },
  ...
  subagent: {
    ...
    intro:
      "عندما يمكن تقسيم المهمة إلى استعلامات مركّزة للقراءة فقط، يستطيع الوكيل الرئيسي تفويضها إلى حلقة فرعية بنموذج وميزانية خطوات خاصين بها. تعمل الوكلاء الفرعية بالتوازي، وتعيد ملخّصًا موجزًا، ولا تلمس أبدًا أي شيء يكتب في نظام خارجي.",
    modelSection: "النموذج",
    auto: "تلقائي",
    autoSub: "يستخدم نموذج التنسيق، أو النموذج الرئيسي إذا لم يُحدَّد.",
    modelFooter:
      "النماذج الأرخص عادةً كافية — يبدأ الوكلاء الفرعيون بسياق نظيف وأدوات للقراءة فقط، لذا نادرًا ما يحتاجون إلى تفكير ثقيل.",
    maxRoundsSection: "الحد الأقصى للجولات",
    maxRoundsFooter:
      "عدد جولات الأدوات لكل وكيل فرعي قبل أن يتعين عليه التلخيص. الجولات الأقل تُبقي الوكيل الفرعي مركّزًا واقتصاديًا.",
  },
  ...
  mcp: {
    listTitle: "خوادم MCP",
    listIntro:
      "MCP (بروتوكول سياق النموذج) هو المعيار المفتوح لتوصيل الذكاء الاصطناعي بالأدوات. اربط أي خادم MCP هنا وستصبح جميع أدواته متاحة للوكيل.",
    listFooter:
      "يتم التصافح مع الخوادم عند الاتصال ويتم تخزينها محلياً. إذا تعطّل خادم ما، تختفي أدواته من مجموعة الوكيل — دون فشل صامت.",
    emptyTitle: "لا توجد خوادم متصلة بعد",
    emptyBody: "اربط Linear أو Sentry أو Notion أو أي خادم MCP. Zapier وحده يفتح 5000+ تطبيق.",
    addFirst: "إضافة خادم",
    addTitle: "إضافة خادم MCP",
    addSubtitle: "اختر خادماً شائعاً أو أدخل عنوان URL مخصص.",
    popular: "الشائعة",
    addCustom: "خادم MCP مخصص",
    addFooter: "يجب أن يشير عنوان URL إلى نقطة نهاية MCP للخادم، وليس صفحة التطبيق الرئيسية.",
    customFormTitle: "خادم مخصص",
    serverDetails: "الخادم",
    serverName: "الاسم",
    serverUrl: "العنوان",
    auth: "المصادقة",
    bearerOptional: "رمز Bearer (اختياري)",
    testAndConnect: "اختبر واتصل",
    testFooter: "سنجري تصافحاً مع الخادم ونسرد أدواته قبل الحفظ.",
    connectedTitle: "متصل",
    connectedToolOne: "تم اكتشاف أداة واحدة.",
    connectedToolOther: "تم اكتشاف {{count}} أداة.",
    errNameOrUrl: "أعطِ الخادم اسماً وعنوان نقطة النهاية.",
    errInvalidUrl: "لا يبدو أن هذا عنوان URL صالح.",
    errConnectTitle: "تعذّر الاتصال",
    errRefreshTitle: "تعذّر التحديث",
    notFoundTitle: "لم يتم العثور على الخادم",
    notFoundBody: "ربما تم حذف هذا الخادم.",
    serverInfo: "الخادم",
    url: "العنوان",
    lastSync: "آخر مزامنة",
    never: "أبداً",
    paused: "متوقّف مؤقتاً",
    pausedHint: "عند الإيقاف المؤقت، تُخفى أدوات هذا الخادم عن الوكيل.",
    refresh: "تحديث الأدوات",
    toolOne: "{{count}} أداة",
    toolOther: "{{count}} أدوات",
    noToolsCached: "لا توجد أدوات مخزّنة مؤقتاً. اضغط تحديث بالأعلى.",
    noToolsYet: "لا أدوات بعد",
    readOnly: "للقراءة فقط",
    trusted: "موثوق",
    trustedHint: "تعمل الأدوات الموثوقة دون طلب تأكيد. أدوات القراءة فقط تعمل دون تأكيد دائماً.",
    disconnectTitle: "قطع اتصال الخادم",
    disconnectBody: "إزالة {{name}} وجميع أدواته من مجموعة أدوات الوكيل؟",
  },

  customTools: {
    listTitle: "أدوات HTTP",
    listIntro:
      "اربط الوكيل بأي واجهة REST API. إذا لم يكن لخدمتك خادم MCP بعد، يمكنك ربطها هنا — أعلن نقطة النهاية والرؤوس والمعاملات.",
    listFooter: "الأدوات المعطّلة تبقى محفوظة لكنها لم تعد تُقدَّم للوكيل.",
    emptyTitle: "لا توجد أدوات مخصصة بعد",
    emptyBody: "صِف واجهة API بالنص ودع الوكيل يصوغ الأداة، أو ابدأ فارغاً.",
    addFirst: "إضافة أداة",
    paused: "متوقّفة مؤقتاً",
    newTitle: "أداة مخصصة جديدة",
    newSubtitle: "صِف الواجهة، أو ابدأ من الصفر.",
    aiGenerate: "إنشاء من الوصف",
    aiPlaceholder:
      "مثال: اتصل بـ https://api.myapp.com/orders بـ bearer XYZ. GET /orders تُرجع قائمة. POST /orders يستقبل {status, total}.",
    aiHint: "يقرأ الوكيل الوصف ويصوغ الأداة. تراجعها قبل الحفظ.",
    generateBtn: "إنشاء الأداة",
    orDivider: "أو",
    startBlank: "ابدأ فارغاً",
    errNeedDescription: "اكتب وصفاً أولاً.",
    errGenerate: "تعذّر الإنشاء",
    errNameOrUrl: "الأداة تحتاج إلى اسم وعنوان URL.",
    notFoundTitle: "لم يتم العثور على الأداة",
    meta: "البيانات الوصفية",
    name: "الاسم (استخدام داخلي)",
    label: "التسمية (تظهر في التتبّع)",
    description: "الوصف (يقرأه النموذج)",
    descHint: "الوصف هو ما يقرر متى يستدعي النموذج هذه الأداة. كن محدداً.",
    request: "الطلب",
    url: "قالب URL",
    body: "قالب Body",
    placeholdersHint: "استخدم {{param}} لحقن معامل في URL أو الرؤوس أو body.",
    headers: "الرؤوس",
    noHeaders: "لا رؤوس بعد.",
    addHeader: "إضافة رأس",
    parameters: "المعاملات",
    paramsHint: "المعاملات التي سيمررها النموذج. يجب أن تتطابق أسماؤها مع {{placeholders}} المستخدمة أعلاه.",
    noParams: "لا معاملات بعد.",
    paramDescPh: "وصف للنموذج",
    required: "مطلوب",
    addParam: "إضافة معامل",
    behavior: "السلوك",
    mutates: "يتطلب موافقة",
    mutatesHint: "فعّل إذا كانت هذه الأداة تُغيّر شيئاً. سيُطلب من المستخدم تأكيد كل استدعاء.",
    pauseTitle: "متوقّفة مؤقتاً",
    pauseHint: "تبقى الأداة محفوظة لكن الوكيل لا يراها.",
    deleteTitle: "حذف الأداة",
    deleteBody: "حذف {{name}} نهائياً؟ لا يمكن التراجع عن هذا.",
  },
