...
const pt: Dict = {
  ...
  settings: {
    ...
    mcpSub: "Conecte qualquer ferramenta do ecossistema MCP.",
    customToolsTitle: "Ferramentas HTTP customizadas",
    customToolsSub: "Ligue o agente em qualquer API REST sua.",
    extensionsFooter:
      "MCP traz servidores prontos (Linear, Sentry, Notion, os 5000+ apps do Zapier). Custom HTTP cobre qualquer outra coisa — seu próprio backend, uma API interna, um SaaS de nicho.",
  },
  ...
  mcp: {
    listTitle: "Servidores MCP",
    listIntro:
      "MCP (Model Context Protocol) é o padrão aberto de conexão IA-ferramenta. Conecte qualquer servidor MCP aqui e todas as tools dele ficam disponíveis pro agente.",
    listFooter:
      "Servidores rodam handshake ao conectar e ficam cacheados localmente. Se um servidor cair, as tools dele somem do repertório do agente — nada de falha silenciosa.",
    emptyTitle: "Nenhum servidor conectado",
    emptyBody:
      "Conecte Linear, Sentry, Notion ou qualquer servidor MCP. Só o Zapier já destrava 5000+ apps.",
    addFirst: "Adicionar servidor",
    addTitle: "Adicionar servidor MCP",
    addSubtitle: "Escolha um popular ou digite uma URL customizada.",
    popular: "POPULARES",
    addCustom: "Servidor MCP customizado",
    addFooter:
      "A URL precisa apontar pro endpoint MCP do servidor, não pra landing page do app.",
    customFormTitle: "Servidor customizado",
    serverDetails: "SERVIDOR",
    serverName: "Nome",
    serverUrl: "URL",
    auth: "AUTENTICAÇÃO",
    bearerOptional: "Bearer token (opcional)",
    testAndConnect: "Testar e conectar",
    testFooter: "Vamos abrir um handshake com o servidor e listar as tools antes de salvar.",
    connectedTitle: "Conectado",
    connectedToolOne: "1 tool descoberta.",
    connectedToolOther: "{{count}} tools descobertas.",
    errNameOrUrl: "Dá um nome pro servidor e a URL do endpoint.",
    errInvalidUrl: "Isso não parece uma URL válida.",
    errConnectTitle: "Não deu pra conectar",
    errRefreshTitle: "Não deu pra atualizar",
    notFoundTitle: "Servidor não encontrado",
    notFoundBody: "Esse servidor pode ter sido removido.",
    serverInfo: "SERVIDOR",
    url: "URL",
    lastSync: "Último sync",
    never: "Nunca",
    paused: "Pausado",
    pausedHint: "Quando pausado, as tools desse servidor somem do agente.",
    refresh: "Atualizar tools",
    toolOne: "{{count}} TOOL",
    toolOther: "{{count}} TOOLS",
    noToolsCached: "Nenhuma tool cacheada. Toca em atualizar acima.",
    noToolsYet: "Sem tools ainda",
    readOnly: "SÓ LEITURA",
    trusted: "CONFIÁVEL",
    trustedHint:
      "Tools confiáveis rodam sem confirmação. Tools de só leitura sempre rodam sem confirmar.",
    disconnectTitle: "Desconectar servidor",
    disconnectBody: "Remover {{name}} e todas as tools dele do repertório do agente?",
  },

  customTools: {
    listTitle: "Ferramentas HTTP",
    listIntro:
      "Ligue o agente em qualquer API REST. Se seu serviço ainda não tem servidor MCP, dá pra conectar por aqui — declara endpoint, headers e parâmetros, e o agente chama.",
    listFooter: "Tools desativadas ficam salvas mas param de ser oferecidas pro agente.",
    emptyTitle: "Sem tools customizadas ainda",
    emptyBody:
      "Descreve uma API em texto e o agente monta a tool pra você, ou começa do zero.",
    addFirst: "Adicionar tool",
    paused: "pausada",
    newTitle: "Nova tool customizada",
    newSubtitle: "Descreve a API ou começa em branco.",
    aiGenerate: "GERAR A PARTIR DE DESCRIÇÃO",
    aiPlaceholder:
      "ex: Conecta em https://api.meuapp.com/orders com bearer token XYZ. GET /orders devolve uma lista. POST /orders recebe {status, total}.",
    aiHint: "O agente lê a descrição e monta a tool. Você revisa antes de salvar.",
    generateBtn: "Gerar tool",
    orDivider: "ou",
    startBlank: "Começar em branco",
    errNeedDescription: "Digita uma descrição primeiro.",
    errGenerate: "Não deu pra gerar",
    errNameOrUrl: "A tool precisa de nome e URL.",
    notFoundTitle: "Tool não encontrada",
    meta: "METADADOS",
    name: "Nome (uso interno)",
    label: "Label (aparece no trace)",
    description: "Descrição (o modelo lê)",
    descHint:
      "A descrição é como o modelo decide quando chamar. Seja específico: o que faz, quando usar, o que retorna.",
    request: "REQUEST",
    url: "Template da URL",
    body: "Template do body",
    placeholdersHint: "Use {{param}} pra injetar um parâmetro na URL, headers ou body.",
    headers: "HEADERS",
    noHeaders: "Sem headers ainda.",
    addHeader: "Adicionar header",
    parameters: "PARÂMETROS",
    paramsHint:
      "Parâmetros que o modelo vai passar. O nome tem que bater com os {{placeholders}} usados acima.",
    noParams: "Sem parâmetros ainda.",
    paramDescPh: "Descrição pro modelo",
    required: "Obrigatório",
    addParam: "Adicionar parâmetro",
    behavior: "COMPORTAMENTO",
    mutates: "Precisa de aprovação",
    mutatesHint:
      "Liga se essa tool muda alguma coisa. O usuário vai confirmar toda chamada.",
    pauseTitle: "Pausada",
    pauseHint: "A tool fica salva mas o agente não enxerga.",
    deleteTitle: "Excluir tool",
    deleteBody: "Excluir {{name}} de vez? Isso não tem volta.",
  },
