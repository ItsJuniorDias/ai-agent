...
const fr: Dict = {
  ...
  settings: {
    ...
    mcpSub: "Connectez n'importe quel outil de l'écosystème MCP.",
    customToolsTitle: "Outils HTTP personnalisés",
    customToolsSub: "Connectez l'agent à n'importe quelle API REST.",
    extensionsFooter:
      "MCP apporte des serveurs prêts (Linear, Sentry, Notion, les 5000+ apps de Zapier). Les outils HTTP couvrent le reste — votre backend, une API interne, un SaaS de niche.",
  },
  ...
  mcp: {
    listTitle: "Serveurs MCP",
    listIntro:
      "MCP (Model Context Protocol) est le standard ouvert pour connecter l'IA aux outils. Connectez n'importe quel serveur MCP ici et tous ses outils deviennent disponibles pour l'agent.",
    listFooter:
      "Les serveurs sont authentifiés à la connexion et mis en cache localement. Si un serveur tombe, ses outils disparaissent — pas d'échec silencieux.",
    emptyTitle: "Aucun serveur connecté",
    emptyBody:
      "Connectez Linear, Sentry, Notion ou tout autre serveur MCP. Zapier seul débloque 5000+ apps.",
    addFirst: "Ajouter un serveur",
    addTitle: "Ajouter un serveur MCP",
    addSubtitle: "Choisissez un serveur populaire ou entrez une URL personnalisée.",
    popular: "POPULAIRES",
    addCustom: "Serveur MCP personnalisé",
    addFooter: "L'URL doit pointer sur l'endpoint MCP, pas sur la page d'accueil de l'app.",
    customFormTitle: "Serveur personnalisé",
    serverDetails: "SERVEUR",
    serverName: "Nom",
    serverUrl: "URL",
    auth: "AUTHENTIFICATION",
    bearerOptional: "Bearer token (optionnel)",
    testAndConnect: "Tester et connecter",
    testFooter: "Nous ferons un handshake et listerons les outils avant d'enregistrer.",
    connectedTitle: "Connecté",
    connectedToolOne: "1 outil découvert.",
    connectedToolOther: "{{count}} outils découverts.",
    errNameOrUrl: "Donnez un nom au serveur et son URL.",
    errInvalidUrl: "Ceci ne ressemble pas à une URL valide.",
    errConnectTitle: "Impossible de connecter",
    errRefreshTitle: "Impossible d'actualiser",
    notFoundTitle: "Serveur introuvable",
    notFoundBody: "Ce serveur a peut-être été supprimé.",
    serverInfo: "SERVEUR",
    url: "URL",
    lastSync: "Dernière synchro",
    never: "Jamais",
    paused: "En pause",
    pausedHint: "En pause, les outils de ce serveur sont cachés à l'agent.",
    refresh: "Actualiser les outils",
    toolOne: "{{count}} OUTIL",
    toolOther: "{{count}} OUTILS",
    noToolsCached: "Aucun outil en cache. Appuyez sur actualiser en haut.",
    noToolsYet: "Pas encore d'outils",
    readOnly: "LECTURE SEULE",
    trusted: "APPROUVÉ",
    trustedHint:
      "Les outils approuvés s'exécutent sans confirmation. Les lecture-seule aussi, toujours.",
    disconnectTitle: "Déconnecter le serveur",
    disconnectBody: "Retirer {{name}} et tous ses outils du kit de l'agent ?",
  },

  customTools: {
    listTitle: "Outils HTTP",
    listIntro:
      "Connectez l'agent à n'importe quelle API REST. Si votre service n'a pas de serveur MCP, vous pouvez le connecter ici — déclarez endpoint, headers et paramètres.",
    listFooter: "Les outils désactivés restent sauvegardés mais ne sont plus proposés à l'agent.",
    emptyTitle: "Pas encore d'outils personnalisés",
    emptyBody: "Décrivez une API en texte et l'agent la construit, ou partez de zéro.",
    addFirst: "Ajouter un outil",
    paused: "en pause",
    newTitle: "Nouvel outil",
    newSubtitle: "Décrivez l'API ou partez de zéro.",
    aiGenerate: "GÉNÉRER DEPUIS UNE DESCRIPTION",
    aiPlaceholder:
      "ex : Se connecte à https://api.monapp.com/orders avec bearer XYZ. GET /orders renvoie une liste. POST /orders reçoit {status, total}.",
    aiHint: "L'agent lit la description et construit l'outil. Vous vérifiez avant d'enregistrer.",
    generateBtn: "Générer l'outil",
    orDivider: "ou",
    startBlank: "Partir de zéro",
    errNeedDescription: "Écrivez une description d'abord.",
    errGenerate: "Impossible de générer",
    errNameOrUrl: "L'outil a besoin d'un nom et d'une URL.",
    notFoundTitle: "Outil introuvable",
    meta: "MÉTADONNÉES",
    name: "Nom (interne)",
    label: "Libellé (visible dans le trace)",
    description: "Description (lue par le modèle)",
    descHint: "La description dicte quand le modèle appelle. Soyez précis.",
    request: "REQUEST",
    url: "Template d'URL",
    body: "Template du body",
    placeholdersHint: "Utilisez {{param}} pour injecter un paramètre dans l'URL, headers ou body.",
    headers: "HEADERS",
    noHeaders: "Pas encore de headers.",
    addHeader: "Ajouter un header",
    parameters: "PARAMÈTRES",
    paramsHint:
      "Paramètres que le modèle passera. Leurs noms doivent correspondre aux {{placeholders}} utilisés au-dessus.",
    noParams: "Pas encore de paramètres.",
    paramDescPh: "Description pour le modèle",
    required: "Requis",
    addParam: "Ajouter un paramètre",
    behavior: "COMPORTEMENT",
    mutates: "Nécessite approbation",
    mutatesHint:
      "Activez si cet outil modifie quelque chose. L'utilisateur confirmera chaque appel.",
    pauseTitle: "En pause",
    pauseHint: "L'outil reste sauvegardé mais l'agent ne le voit pas.",
    deleteTitle: "Supprimer l'outil",
    deleteBody: "Supprimer {{name}} définitivement ? Irréversible.",
  },
